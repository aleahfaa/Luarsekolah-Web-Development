...
<body class="bg-gray-100">
    ...
    <section id="services" class="mt-10 mb-10 px-4">
        ...
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide service bg-white border p-4 text-center">
                    <a href="{{ route('cleaning-products') }}" class="block w-full h-full">
                ...
                <div class="swiper-slide service bg-white border p-4 text-center">
                    <a href="{{ route('fashion') }}" class="block w-full h-full">
                        <div class="services-img">
                ...
                <div class="swiper-slide service bg-white border p-4 text-center">
                    <a href="{{ route('home-goods') }}" class="block w-full h-full">
                        <div class="services-img">
    ...
    <section id="testimonials" class="testimonials flex justify-around mb-10 px-4">
        ...
        <div class="testimonial bg-white border p-4 w-1/2 text-center">
            <p>"I love how easy it is to find eco-friendly alternatives at Green Mart." - John D.</p>
        </div>
    </section>
