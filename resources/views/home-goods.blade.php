...
<head>
    ...
    <title>Eco-Friendly Home Goods - Green Mart</title>
...
<body class="bg-gray-100 d-flex flex-column min-vh-100">
    ...
    <main style="flex-grow: 1; min-height: calc(100vh - 140px);">
        <section class="mt-10 mb-10 px-4 flex-grow-1">
            <h2 class="text-3xl font-bold text-center mb-6">Eco-Friendly Home Goods</h2>
            <form action="{{ url('home-goods') }}" method="GET" class="search-form">
